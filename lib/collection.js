...
Collection.prototype._acquireLock = function() {
...
Collection.prototype._releaseLock = function() {
  this._options.lock = false;
...
Collection.prototype._wait = function() {
  var ths = this;
  while(this._options.lock == true) {
    console.log("waiting");
    this._client.readFile(ths._dbdbfile, function(err, str, stat) {
